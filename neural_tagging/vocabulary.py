...
from neural_tagging.common import *
from neural_tagging.extract_tags_from_UD import make_UD_pos_and_tag, make_full_UD_tag
...
class FeatureVocabulary(Vocabulary):
    ...
    def to_vector(self, x):
        index = self.toidx(x)
        return self.symbol_matrix_[index]
